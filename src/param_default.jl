...
param_default=Dict(
    ...
    "dvid_age" => 20,                 # cell age for timer-like (age) cell division
    "dvid_cirT"=> 18,                 # time for timer-like (circadian clock) cell division
    "dvid_PAR" => 45.0,               # light for timer-like (light circadian clock) cell division
