...
param_default=Dict(
    ...
    "Grz_P"    => 5000,               # Grazing probability scalar
    ...
    "dvid_size"=> [1.9,1.9],          # Regulations of cell division (sizer)
    "dvid_add" => [1.0,1.0],          # Regulations of cell division (adder)
    "dvid_cirT"=> [19,19],            # Regulations of cell division (timer-cirT)
    "dvid_par" => [50,50],            # Regulations of cell division (timer-par)
    "mitosis"  => [0.0,0.0],          # whether to include the process of mitosis
