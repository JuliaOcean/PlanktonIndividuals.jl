@inline function fill_halo_horizontally_periodic(c, g::RegularRectilinearGrid)
...
@inline function fill_halo_nut!(nuts::NamedTuple, g::RegularRectilinearGrid)
    for nut in nuts
...
@inline function fill_halo_vel!(vels::NamedTuple, g::RegularRectilinearGrid)
    for vel in vels
...
@inline function fill_halo_Gcs!(nuts::NamedTuple, g::RegularRectilinearGrid)
    for nut in nuts
