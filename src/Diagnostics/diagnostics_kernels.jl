...
function diags_spcs!(diags_sp, plank::phytoplankton, ac, x, y, z, mode::AbstractMode, arch::Architecture)
    ...
    elseif isa(mode, IronEnergyMode)
        diags = (:PS, :CF, :ECF, :RS, :ERS, :NR, :ENR, :NF, :ENF, :BS, :VNH4, :VNO3, :VPO4, :VFe, :PS2ST, :ST2PS, :NR2ST, :ST2NR, :NF2ST, :ST2NF, :Bm, :exEn, :CH, :qNO3, :qNH4, :qP, :qFe, :qFePS, :qFeNR, :qFeNF, :Chl, :ATP, :ADP, :tdark)
    end
