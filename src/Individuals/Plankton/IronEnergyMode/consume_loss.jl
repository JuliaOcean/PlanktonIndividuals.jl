...
@kernel function calc_consume_kernel!(ctsdic, ctsnh4, ctsno3, ctspo4, ctsdfe, 
                                        plank, ac, x, y, z, ΔT)
    i = @index(Global)
...
function calc_consume!(ctsdic, ctsnh4, ctsno3, ctspo4, ctsdfe, plank, ac, x, y, z, ΔT, arch)
    kernel! = calc_consume_kernel!(device(arch), 256, (size(ac,1)))
    kernel!(ctsdic, ctsnh4, ctsno3, ctspo4, ctsdfe, plank, ac, x, y, z, ΔT)
    return nothing 
end

##### deal with grazed or dead individuals
@kernel function calc_loss_kernel!(ctsnh4, ctsno3, ctsdoc, ctspoc, ctsdon, ctspon, 
                                    ctsdop, ctspop, ctsdfe, ctspfe_bio,
                                    plank, ac, x, y, z, loss, 
...
function calc_loss!(ctsnh4, ctsno3, ctsdoc, ctspoc, ctsdon, ctspon, ctsdop, ctspop, ctsdfe, ctspfe_bio, 
    ...
    kernel!(ctsnh4, ctsno3, ctsdoc, ctspoc, ctsdon, ctspon, ctsdop, ctspop, ctsdfe, ctspfe_bio, 
