...
function vel_copy!(vel::NamedTuple, u, v, w, g::RegularRectilinearGrid)
...
@inline function copy_interior!(c, t, g::RegularRectilinearGrid)
    copyto!(view(c, g.Hx+1:g.Hx+g.Nx, g.Hy+1:g.Hy+g.Ny, g.Hz+1:g.Hz+g.Nz), t)
end
@inline function copy_interior_bounded!(c, t, g::RegularRectilinearGrid)
