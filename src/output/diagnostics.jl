...
function sum_diags!(diags, plank, inds::AbstractArray{Int64,2}, sp::Int64,
...
function sum_diags_mort!(diags, plank, inds::AbstractArray{Int64,2}, sp::Int64,
                         arch::Architecture, g::Grids, diag_t)
...
function sum_diags_dvid!(diags, plank, inds::AbstractArray{Int64,2}, sp::Int64,
                         arch::Architecture, g::Grids, diag_t)
