...
param_default=Dict(
    ...
    "P_Nsuper" => [1e10, 1e10],       # Number of phyto cells each super individual represents
    ...
    "P_mean"   => [1.5, 1.5],         # Mean of the normal distribution of initial phyto individuals
    "P_var"    => [0.3, 0.3],         # Variance of the normal distribution of initial phyto individuals
    ...
    "Grz_P"    => [4000, 4000],       # Grazing probability scalar
    "Grz_stp"  => [0, 0],             # Grazing probability decrease with depth
    ...
    "VPmax"    => [1.2e-6, 1.2e-6],   # Maximum P uptake rate (mmol P/mmol C/second)
