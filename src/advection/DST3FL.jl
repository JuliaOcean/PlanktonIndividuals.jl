...
@inline CFLx(i, j, k, g::RegularRectilinearGrid, u, ΔT) = @inbounds abs(u[i, j, k] * ΔT / g.Δx)
@inline CFLy(i, j, k, g::RegularRectilinearGrid, v, ΔT) = @inbounds abs(v[i, j, k] * ΔT / g.Δy)
@inline CFLz(i, j, k, g::RegularRectilinearGrid, w, ΔT) = @inbounds abs(w[i, j, k] * ΔT / g.Δz)
...
@inline Trans_x(i, j, k, g::RegularRectilinearGrid, u) = @inbounds g.Ax * u[i, j, k]
@inline Trans_y(i, j, k, g::RegularRectilinearGrid, v) = @inbounds g.Ay * v[i, j, k]
@inline Trans_z(i, j, k, g::RegularRectilinearGrid, w) = @inbounds g.Az * w[i, j, k]
...
##### calculate Ψ⁺ and Ψ⁻
@inline Ψx⁺(i, j, k, g::RegularRectilinearGrid, u, c, ΔT) = 
...
@inline Ψy⁺(i, j, k, g::RegularRectilinearGrid, v, c, ΔT) = 
...
@inline Ψz⁺(i, j, k, g::RegularRectilinearGrid, w, c, ΔT) = 
...
##### advection flux
@inline function adv_flux_x(i, j, k, g::RegularRectilinearGrid, u, c, ΔT)
...
@inline adv_flux_y(i, j, k, g::RegularRectilinearGrid, v, c, ΔT) =
