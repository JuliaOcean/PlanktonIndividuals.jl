...
function phyt_params_default(N::Int64, mode::IronEnergyMode)
    params=Dict(
        ...
        "PCmax"     => [2.4],     # Maximum light harvesting rate (μJ/mmolC/second) 
        ...
        "e_cf"      => [2.7e8],   # Energy consumption rate of carbon fixation (μJ/mmolC)
        "e_rs"      => [1.5e8],   # Energy production rate of respiration (μJ/mmolC)
        "e_nf"      => [2.4e8],   # Energy consumption rate of N fixation (μJ/mmolN)
        "e_nr"      => [3.0e8],   # ??Energy consumption rate of NO3 reduction (μJ/mmolN)
