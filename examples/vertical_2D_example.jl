...
model = PlanktonModel(arch, grid; phyto = phyto_setup(nothing, [2^7], 1),
...
begin
	model.nutrients.DOC.data[:,:,1:66] .= 1.5
	model.nutrients.DOC.data[:,:,67:end] .= 2.0
	nothing
end
...
sim = PlanktonSimulation(model, ΔT = 60.0, iterations = 1,
...
We run the model for 240 time steps (4 hours) and generate an animation.
"""
...
# ╔═╡ 937fb5e8-29a1-4857-9995-125b9b3f566e
md"""
...
# ╔═╡ 566cb4e5-51af-4206-b72c-1c6dd223fcd6
md"""
The animation is generated using the following code.
"""

# ╔═╡ 4d2cfac4-416c-4b87-a09e-e7e99ca91b65
begin
...
manifest_format = "2.0"
project_hash = "ab3a64976ad7e1207503f66f4a69c09dbc6719d3"
